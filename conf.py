...
BLOG_AUTHOR = "Aubrey Moore"  # (translatable)
BLOG_TITLE = "Ag/BI 345 - General Entomology - Fall 2017"  # (translatable)
...
BLOG_EMAIL = "aubreymoore@guam.net"
BLOG_DESCRIPTION = "Site for AG/BI345 - General Entomology - Fall 2017"  # (translatable)
